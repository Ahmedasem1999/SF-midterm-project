...
def measure_detection_performance(detections, labels, labels_valid, min_iou=0.5):
    ...
    for label, valid in zip(labels, labels_valid):
        ...
        if valid: # exclude all labels from statistics which are not considered valid
            ...
            box = label.box
            boxx_1 = tools.compute_box_corners(box.center_x, box.center_y, box.width, box.length, box.heading)
            ...
            for detection in detections:
                ...
                boxx_2 = tools.compute_box_corners(x, y, w, l, yaw)
                ...
                try:
                    polly_1 = Polygon(boxx_1)
                    polly_2 = Polygon(boxx_2)
                    intersection = polly_1.intersection(polly_2).area 
                    union = polly_1.union(polly_2).area
